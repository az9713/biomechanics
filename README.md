# Quantitative Human Musculoskeletal Science

A mathematically rigorous course on the human musculoskeletal system as a
controlled, multiscale mechanical–biological system. Each module is a
self-contained HTML page with derivations, Python-computed simulations, and
inline SVG figures.
